      ...
      <View style={styles.orderContent}>
        <View style={styles.orderDetailsContainer}>
          ...
          <Text style={styles.orderDate}>{
            format(new Date(item.created_at), 'dd MMM, yyyy')}</Text>
        </View>

        {/* Status Badge- the status taken from the style at the bottom */}
...
const Orders = () => {
  ...
  if(error || !orders) return <Text>{error?.message}</Text>
